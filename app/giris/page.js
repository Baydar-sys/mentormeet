  ...
  return (
    <main className="min-h-screen bg-white flex flex-col md:flex-row">
      ...
      <div className="flex-1 flex flex-col">
        ...
        {/* Mobil üst bar */}
        <div className="md:hidden bg-gray-900 px-6 py-24 text-center">
  <a href="/" className="font-semibold text-white text-xl">MentorMeet</a>
  <p className="text-gray-400 text-sm mt-2">Hoş geldin</p>
</div>
