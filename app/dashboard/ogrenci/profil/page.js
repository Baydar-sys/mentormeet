            ...
            <div className="flex gap-2">
              {['Lise', 'Üniversite', 'Mezun'].map((s) => (
                <button
                  key={s}
                  onClick={() => setEgitim(s)}
                  className={'flex-1 py-2.5 rounded-lg text-sm border transition-all ' + (egitim === s ? 'text-white border-transparent' : 'bg-white text-gray-600 border-gray-200 hover:border-gray-400')}
                  style={egitim === s ? {backgroundColor: '#1f2937'} : {}}
                >
                  {s}
                </button>
              ))}
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {alanlar.map((a) => (
                <button
                  key={a}
                  onClick={() => ilgiToggle(a)}
                  className={'px-4 py-2 rounded-lg text-sm border transition-all ' + (ilgiAlanlari.includes(a) ? 'text-white border-transparent' : 'bg-white text-gray-600 border-gray-200 hover:border-gray-400')}
                  style={ilgiAlanlari.includes(a) ? {backgroundColor: '#1f2937'} : {}}
                >
                  {a}
                </button>
              ))}
